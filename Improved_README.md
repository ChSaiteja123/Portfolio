# 🚀 Production-Ready DevSecOps CI/CD Pipeline for React

> Modern DevSecOps pipeline demonstrating automated build, security scanning, containerization, and deployment to Amazon EKS.
